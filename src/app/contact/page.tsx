...
export const metadata: Metadata = { title: "Request a Report", description: "Describe the industrial intelligence question, decision and timeframe you need Lemon Cactus to assess.", alternates: { canonical: "/contact" } };
