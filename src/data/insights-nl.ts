...
const originalInsightsNl: readonly Insight[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "Bruikbare signalen staan vaak verspreid in publicaties voor uiteenlopende doelgroepen. Jaarverslagen kunnen strategie toelichten; productdocumentatie beschrijft beoogde prestaties. Octrooien geven een technische richting aan. Vacatures wijzen op benodigde vaardigheden. Aanbestedingen, vergunningen en certificeringen voegen context toe over timing, locatie of naleving. Openbare foto’s en video’s kunnen helpen toetsen of een geclaimde capaciteit fysiek aannemelijk is.",
          "Geen enkele bron is automatisch doorslaggevend. Bedrijfstaal is selectief, beelden missen context en openbare databanken kunnen onvolledig zijn. De analist beoordeelt herkomst, actualiteit, samenhang en publicatiedoel en toetst signalen aan onafhankelijk materiaal.",
        ],
        bullets: [
      ...
      },
      {
        ...
        paragraphs: [
          "Een professioneel rapport onderscheidt directe waarneming van interpretatie. Een planningsdocument kan bevestigen dat een uitbreiding is vergund. Openbare beelden kunnen aangeven dat er is gebouwd. Vacatures kunnen de beoordeling ondersteunen dat een bedrijf zich op een grotere doorvoer voorbereidt. Geen van deze bronnen bewijst op zichzelf de huidige productiecapaciteit.",
          "Duidelijke zekerheidsniveaus helpen u dat onderscheid te begrijpen. Bevestigde bevindingen steunen op sterk direct bewijs. Een beoordeling met hoge zekerheid wordt door consistent bewijs ondersteund en kent weinig resterende onzekerheid. Matige of indicatieve signalen kunnen nuttig zijn, maar zijn vragen om te toetsen, geen vaststaande feiten om te herhalen.",
        ],
      },
      {
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "Stel vóór de interpretatie vast waar het beeld vandaan komt, wanneer het is gepubliceerd, of de genoemde locatie geloofwaardig is en of er oudere versies bestaan. Bedrijfswebsites, beursberichten, leverancierscases, wervingsmateriaal en openbare planningsdocumenten kunnen hetzelfde beeld met verschillende bijschriften tonen. Die verschillen kunnen betekenis hebben.",
          "Ook de omringende pagina telt mee. Een leverancier kan het geïnstalleerde model en de leverdatum noemen. Een bedrijfsbijschrift kan de lijn of het klantprogramma duiden. Een planningsdocument kan het gebouw bevestigen. Door de oorspronkelijke URL, vastlegdatum en relevante context te bewaren, blijft het bewijs controleerbaar en wordt een losgeraakte afbeelding minder snel verkeerd gebruikt.",
        ],
      },
      {
        heading: "Zichtbare kenmerken zijn nog geen bewezen capaciteit",
        paragraphs: [
          "Een goede analyse beschrijft eerst wat rechtstreeks zichtbaar is en pas daarna wat dit mogelijk betekent. Een beeld kan apparatuur, herhaalde werkstations, gemarkeerde productiezones, ventilatievoorzieningen, opslag of beschermingsmaatregelen tonen. Dat zijn waarnemingen. Voor de conclusie dat een locatie een bepaald proces kan uitvoeren, is aanvullend technisch bewijs en context nodig.",
          "Verborgen specificaties blijven verborgen. Pixels bewijzen geen materiaalsamenstelling. De buitenkant van een behuizing onthult geen interne toleranties. Een schone uitstraling bewijst geen gecertificeerde reinheidsklasse. Beelden kunnen mogelijkheden inperken of een claim tegenspreken, maar maken ontoegankelijke details niet kenbaar.",
        ],
        bullets: [
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          "Door bewijs, beoordeling en gevolgtrekking te scheiden, wordt de redenering zichtbaar. Het rapport wordt daardoor niet zwakker: u ziet juist waarop de zekerheid berust en waar extra verificatie nuttig is. Dat is vooral belangrijk wanneer technisch bewijs onvolledig is of bronnen een commercieel belang hebben bij grote claims.",
        ],
      },
      {
        ...
        paragraphs: [
          ...
          "De kwaliteit van bewijs verschilt. Een officieel register kan betrouwbaar zijn voor de datum van een aanvraag, maar niets zeggen over de huidige bedrijfsvoering. Een bedrijfsbrochure is primair bewijs van wat het bedrijf beweert, geen onafhankelijke bevestiging dat die claim klopt. Beschrijf nooit meer dan de bron werkelijk ondersteunt.",
        ],
      },
      {
        ...
        paragraphs: [
          ...
          "Een beoordeling vermeldt de mate van zekerheid en de belangrijkste onderbouwing. Ook tegenbewijs hoort erbij. Als een bedrijf later een introductie uitstelt of vacatures onvervuld blijven, moet het rapport uitleggen hoe dat het oordeel beïnvloedt, in plaats van alleen gunstige bronnen te kiezen.",
        ],
        bullets: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "De nuttigste gevolgtrekkingen laten alternatieven zien. Als een uitbreiding zowel meer volume als een nieuwe productlijn kan ondersteunen, moeten beide verklaringen zichtbaar blijven totdat een andere bron onderscheid maakt. Zo wordt een mogelijke verklaring niet ongemerkt tot zekerheid verheven.",
        ],
      },
      {
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          "Een vacature kan apparatuur en processen noemen. Een leverancierscase kan een locatie en installatie identificeren. Een beursvideo kan de opstelling rond een prototype tonen. Een planningsdocument kan het gebruik van een gebouw aangeven. Samen kunnen die bronnen een buitenstaander meer inzicht geven in koers, gereedheid of capaciteit dan de organisatie bedoelde.",
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Verzamel zo weinig mogelijk persoonsgegevens. Namen en individuele profielen zijn zelden nodig, tenzij zij rechtstreeks relevant zijn voor een toegestane zakelijke vraag. Bevindingen richten zich op patronen binnen de organisatie en op de praktische betekenis van de informatie voor concurrenten.",
        ],
      },
      {
