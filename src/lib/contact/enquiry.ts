...
const limits = {
  ...
  outcome: 2_000, target: 1_000, timeframe: 100, report: 160,
...
const required = ["name", "email", "company", "question", "outcome", "timeframe", "report"] as const;
const singleLine = ["name", "email", "company", "role", "target", "timeframe", "report"] as const;
...
export function composeEnquiry(enquiry: Enquiry, receivedAt: Date) {
  const fields = [
    ...
    ["Preferred delivery timeframe", enquiry.timeframe], ["Report option", enquiry.report],
